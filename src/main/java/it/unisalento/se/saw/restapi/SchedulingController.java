...
public class SchedulingController {
    ...
    public ResponseEntity<?> findFreeRooms(@Valid @RequestBody LectureCalendarDto lectureCalendarDto) {
    	try {
    		List<RoomDto> freeRoomDtos = schedulingService.findFreeRooms(lectureCalendarDto.getModule(), 
    				lectureCalendarDto.getStartTime(), lectureCalendarDto.getEndTime(), lectureCalendarDto.getDate());
